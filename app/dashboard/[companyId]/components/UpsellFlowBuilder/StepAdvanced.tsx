...
export default function StepAdvanced({ flow, onUpdate, onSave }: StepAdvancedProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-12 mb-2">Advanced Settings</h1>
        <p className="text-gray-600">Configure advanced options for your funnel</p>
      </div>
      ...
      <FrostedCard>
        <div className="space-y-6">
          ...
          <div className="pt-6 border-t border-[#E5E6EA]">
            <h3 className="text-lg font-semibold text-[#1C1C1F] mb-4">Additional Settings</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-[#E5E6EA]">
                <div>
                  <div className="font-semibold text-gray-12">Enable Analytics Tracking</div>
                  <div className="text-sm text-gray-600">Track visits and conversions</div>
                </div>
